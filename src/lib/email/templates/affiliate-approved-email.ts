// Affiliate approved email template - sent to affiliate when application is approved
interface AffiliateApprovedEmailParams {
  name: string;
  referralCode: string;
}

export function affiliateApprovedEmailTemplate({ name, referralCode }: AffiliateApprovedEmailParams): string {
  const referralLink = `https://linkedgrow.ai/?ref=${referralCode}`;
...
<head>
    ...
    <title>Your LinkedGrow Affiliate Application Has Been Approved!</title>
</head>
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;Congratulations! Your affiliate application has been approved. Start earning 30% lifetime commissions.
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">Hey ${name}!</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">Congratulations! Your affiliate application has been approved. You're now part of the LinkedGrow Affiliate Program.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <div style="background-color: #F8FAFC; border-radius: 8px; padding: 16px;">
                                                <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 14px; line-height: 150%; margin: 0 0 8px 0;">
                                                    <strong>Your referral link:</strong>
                                                </p>
                                                <p style="font-family: 'Inter', sans-serif; color: #0182f2; font-size: 15px; line-height: 150%; margin: 0; word-break: break-all;">
                                                    ${referralLink}
                                                </p>
                                            </div>
                                        </td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">Here's what you need to know:</p>
                                            <div style="background-color: #F8FAFC; border-radius: 8px; padding: 16px;">
                                                <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 15px; line-height: 175%; margin: 0;">
                                                    <strong>Commission:</strong> 30% lifetime on every referral<br>
                                                    <strong>Cookie duration:</strong> 30 days<br>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">Share your referral link with your audience and start earning commissions on every paid subscription. You can track your referrals, commissions, and payouts from your affiliate dashboard.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="10" style="line-height: 10px;"></td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" bgcolor="#0182f2" style="border-radius: 8px;">
                                                        <a href="https://linkedgrow.ai/dashboard/affiliate" target="_blank" style="display: block; padding: 16px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; text-align: center;">Go to Your Dashboard</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            ...
                                            <p style="font-family: 'Inter', sans-serif; color: #0182f2; font-size: 14px; line-height: 150%; margin-top: 0; margin-bottom: 0; word-break: break-all;">https://linkedgrow.ai/dashboard/affiliate</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" style="line-height: 20px;"></td>
...
export function affiliateApprovedEmailText({ name, referralCode }: AffiliateApprovedEmailParams): string {
  const referralLink = `https://linkedgrow.ai/?ref=${referralCode}`;

  return `Hey ${name}!

Congratulations! Your affiliate application has been approved. You're now part of the LinkedGrow Affiliate Program.
...
- Commission: 30% lifetime on every referral
- Cookie duration: 30 days
- Minimum payout: $50

Share your referral link with your audience and start earning commissions on every paid subscription. You can track your referrals, commissions, and payouts from your affiliate dashboard.

Go to your dashboard:
https://linkedgrow.ai/dashboard/affiliate
