// LTD welcome email - sent when a user purchases a Lifetime Deal
interface LtdWelcomeEmailParams {
  name?: string;
}

export function ltdWelcomeEmailTemplate({ name }: LtdWelcomeEmailParams): string {
...
<head>
    ...
    <title>You're in for life - Welcome to LinkedGrow Business</title>
</head>
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;Your LinkedGrow Business account is active for life. Set up your AI API key to get started.
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="row" style="padding: 0 50px; line-height: 1;" align="center">
                                            <img src="https://pub-86332bae77404495924b3ef7d4cbe7db.r2.dev/email/welcome.png" loading="lazy" border="0" alt="Welcome to LinkedGrow Business - Lifetime Access" width="540" class="img" style="display: block; max-width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" style="line-height: 20px;"></td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">${greeting} You're in for life.</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">Thank you for grabbing the Lifetime Deal. Your account has been upgraded to the <strong>Business</strong> plan - permanently. No more monthly fees, no more subscriptions. Every feature we build from now on, you get.</p>

                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>One quick thing to get started:</strong></p>

                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">LinkedGrow uses a <strong>Bring Your Own Key</strong> model for AI features. This means you connect your own API key from OpenAI, Claude, Google, or any other provider you prefer. It gives you unlimited content generation at a fraction of what other tools charge - typically just <strong>$2-4/month</strong> in API costs.</p>

                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 0;">Once your API key is connected, head over to your dashboard to create your first AI-powered LinkedIn post, schedule content, and start growing your audience.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" style="line-height: 20px;"></td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" bgcolor="#0182f2" style="border-radius: 8px;">
                                                        <a href="https://linkedgrow.ai/dashboard/settings/ai-api" target="_blank" style="display: block; padding: 16px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; text-align: center;">Connect Your AI API Key</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" style="border-radius: 8px; border: 2px solid #0182f2;">
                                                        <a href="https://linkedgrow.ai/dashboard" target="_blank" style="display: block; padding: 14px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #0182f2; text-decoration: none; border-radius: 6px; text-align: center;">Go to Dashboard</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 0;">You just put a big vote of confidence in what we're building. If you ever need anything, just reply to this email - it comes straight to us.</p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 0;">Thank you for the trust,</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" style="line-height: 20px;"></td>
...
export function ltdWelcomeEmailText({ name }: LtdWelcomeEmailParams): string {
  const greeting = name ? `Hey ${name}!` : "Hey there!";

  return `${greeting} You're in for life.

Thank you for grabbing the Lifetime Deal. Your account has been upgraded to the Business plan - permanently. No more monthly fees, no more subscriptions. Every feature we build from now on, you get.
...
You just put a big vote of confidence in what we're building. If you ever need anything, just reply to this email - it comes straight to us.
