// Support ticket email template - matches transactional email structure exactly
...
export function supportTicketEmailTemplate({
  ...
  const statusText = isLoggedIn !== undefined
    ? `${isLoggedIn ? "Logged-in user" : "Visitor (not logged in)"}${userPlan ? ` - ${userPlan} plan` : ""}`
    : null;
...
<head>
    ...
    <title>Support Ticket from ${escapeHtml(name)}</title>
</head>
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;Support ticket from ${escapeHtml(name)}: ${escapeHtml(message.substring(0, 80))}
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">New Support Ticket</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>Name:</strong> ${escapeHtml(name)}</p>

                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>Email:</strong> <a href="mailto:${escapeHtml(email)}" style="color: #0182f2; text-decoration: none;">${escapeHtml(email)}</a></p>

                                            ${statusText ? `<p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>Status:</strong> ${escapeHtml(statusText)}</p>` : ""}
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 14px; font-weight: 600; line-height: 165%; margin-top: 0; margin-bottom: 8px;">Message:</p>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="background-color: #F8FAFC; border: 1px solid #EAECED; border-radius: 8px; padding: 16px;">
                                                        <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin: 0; white-space: pre-wrap;">${escapeHtml(message)}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 14px; font-weight: 600; line-height: 165%; margin-top: 0; margin-bottom: 8px;">Chat Context:</p>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="background-color: #F0F9FF; border: 1px solid #BAE6FD; border-radius: 8px; padding: 16px;">
                                                        <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 14px; line-height: 180%; margin: 0;">${formatConversationHtml(conversationSummary)}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
