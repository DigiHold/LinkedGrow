...
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;${publisherName} from your "${groupName}" group just published a LinkedIn post. Open it on LinkedIn.
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">New post in your network</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>${publisherName}</strong> from your "<strong>${groupName}</strong>" group just published a LinkedIn post. Open it on LinkedIn to read it and react in your own words.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" bgcolor="#10B981" style="border-radius: 8px;">
                                                        <a href="${linkedinUrl}" target="_blank" style="display: block; padding: 16px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; text-align: center;">View on LinkedIn</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            ...
                                            <p style="font-family: 'Inter', sans-serif; color: #10B981; font-size: 14px; line-height: 150%; margin-top: 0; margin-bottom: 0; word-break: break-all;">${linkedinUrl}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" style="line-height: 20px;"></td>
...
export function networkNotificationNotifyEmailText({ publisherName, groupName, postPreview, linkedinUrl }: NetworkNotificationNotifyEmailParams): string {
  const truncatedPreview = postPreview.length > 200 ? postPreview.slice(0, 200) + "..." : postPreview;

  return `New post in your network

${publisherName} from your "${groupName}" group just published a LinkedIn post. Open it on LinkedIn to read it and react in your own words.

> ${truncatedPreview}

Click the link below to open it on LinkedIn:
