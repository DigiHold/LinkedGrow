// Affiliate rejected email template - sent to affiliate when application is rejected
interface AffiliateRejectedEmailParams {
  name: string;
}

export function affiliateRejectedEmailTemplate({ name }: AffiliateRejectedEmailParams): string {
  return `<!DOCTYPE html>
...
<head>
    ...
    <title>Update on Your LinkedGrow Affiliate Application</title>
</head>
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;An update on your LinkedGrow affiliate application.
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">Thank you for your interest in the LinkedGrow Affiliate Program. We appreciate you taking the time to apply.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">After reviewing your application, we're unable to approve it at this time. This could be due to a variety of reasons, and it doesn't reflect on you personally.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="10" style="line-height: 10px;"></td>
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;">If you'd like more information or would like to reapply in the future, feel free to reach out to us. We'd be happy to help.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="10" style="line-height: 10px;"></td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" bgcolor="#0182f2" style="border-radius: 8px;">
                                                        <a href="mailto:contact@linkedgrow.ai" target="_blank" style="display: block; padding: 16px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; text-align: center;">Contact Us</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
export function affiliateRejectedEmailText({ name }: AffiliateRejectedEmailParams): string {
  return `Hey ${name},

Thank you for your interest in the LinkedGrow Affiliate Program. We appreciate you taking the time to apply.

After reviewing your application, we're unable to approve it at this time. This could be due to a variety of reasons, and it doesn't reflect on you personally.

If you'd like more information or would like to reapply in the future, feel free to reach out to us at contact@linkedgrow.ai. We'd be happy to help.
