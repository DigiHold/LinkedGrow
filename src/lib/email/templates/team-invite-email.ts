...
<head>
    ...
    <title>You've been invited to join ${teamName} on LinkedGrow</title>
</head>
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;${inviterName} has invited you to join ${teamName} as ${roleLabel}.
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">Hey there!</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 10px;"><strong>${inviterName}</strong> has invited you to join <strong>${teamName}</strong> as ${roleLabel} on LinkedGrow.</p>
                                        </td>
                                    </tr>
                                    <tr>
...
export function teamInviteEmailText({ inviterName, teamName, role, inviteUrl }: TeamInviteEmailParams): string {
  const roleLabel = role === "admin" ? "an Admin" : "a Member";

  return `Hey there!

${inviterName} has invited you to join ${teamName} as ${roleLabel} on LinkedGrow.
