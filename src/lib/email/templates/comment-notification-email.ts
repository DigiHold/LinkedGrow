// Comment notification email template - matches exact same structure as welcome/reset/team-invite emails
...
export function commentNotificationEmailTemplate({
  ...
  commentContent,
  isReply,
}: CommentNotificationEmailParams): string {
  const safeContent = commentContent.replace(/</g, "&lt;").replace(/>/g, "&gt;");
  const replyNote = isReply
    ? `<p style="font-family: 'Inter', sans-serif; color: #64748b; font-size: 14px; margin: 0 0 8px 0;">This is a reply to another comment.</p>`
    : "";
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #F4F7FA;">
    <div style="background-color: #F4F7FA; line-height: 100%; font-size: 16px;">
        ...
        <div style="display: none; font-size: 0px; color: #F4F7FA; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
            &nbsp;New comment from ${authorName} needs your approval
        </div>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <h1 style="font-family: 'Inter', sans-serif; color: #0F172B; font-size: 36px; line-height: 125%; font-weight: bold; margin-bottom: 0;">New Comment Awaiting Approval</h1>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <p style="font-family: 'Inter', sans-serif; color: #45556C; font-size: 16px; line-height: 165%; margin-top: 0; margin-bottom: 16px;">A new comment has been posted on your blog and needs your review.</p>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <div style="background-color: #F8FAFC; border-radius: 8px; padding: 16px; margin-bottom: 12px;">
                                                <p style="font-family: 'Inter', sans-serif; color: #64748b; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin: 0 0 4px 0;">Article</p>
                                                <p style="font-family: 'Inter', sans-serif; color: #0f172a; font-size: 16px; font-weight: 500; margin: 0;"><a href="${postUrl}" style="color: #0182f2; text-decoration: none;">${articleTitle}</a></p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" style="color: #45556C;">
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <div style="background-color: #F8FAFC; border-radius: 8px; padding: 16px; margin-bottom: 12px;">
                                                <p style="font-family: 'Inter', sans-serif; color: #64748b; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin: 0 0 4px 0;">Author</p>
                                                <p style="font-family: 'Inter', sans-serif; color: #0f172a; font-size: 16px; font-weight: 500; margin: 0 0 4px 0;">${authorName}</p>
                                                <p style="font-family: 'Inter', sans-serif; color: #64748b; font-size: 14px; margin: 0;">${authorEmail}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td class="row" style="padding: 0 50px;">
                                            <div style="background-color: #F8FAFC; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                                                <p style="font-family: 'Inter', sans-serif; color: #64748b; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin: 0 0 4px 0;">Comment</p>
                                                ${replyNote}
                                                <p style="font-family: 'Inter', sans-serif; color: #0f172a; font-size: 16px; font-weight: 500; margin: 0; white-space: pre-line;">${safeContent}</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="center" bgcolor="#0182f2" style="border-radius: 8px;">
                                                        <a href="${reviewUrl}" target="_blank" style="display: block; padding: 16px 32px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; text-align: center;">Review Comment</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
export function commentNotificationEmailText({
  articleTitle,
  reviewUrl,
  authorName,
  authorEmail,
  ...
  return `New Comment Awaiting Approval

A new comment has been posted on your blog and needs your review.

Article: ${articleTitle}

Author: ${authorName} (${authorEmail})

${isReply ? "This is a reply to another comment.\n\n" : ""}Comment: ${commentContent}

Review this comment: ${reviewUrl}
