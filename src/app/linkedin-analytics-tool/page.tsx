...
const analyticsFAQs = [
  ...
  },
  {
    ...
    answer:
      "LinkedIn native analytics are free for every account. Buffer's free plan includes basic post-level analytics for up to 3 channels. LinkedGrow offers a 7-day Pro trial with full analytics access - no credit card required. After the trial, paid plans start at $13/mo (billed yearly).",
  },
  {
