    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center max-w-xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <div className="w-20 h-20 mx-auto rounded-2xl bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg shadow-cyan-500/30">
        ...
        >
          ...
          <Button
            asChild
            variant="outline"
            className="h-12 px-6 rounded-xl border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
          >
            <Link href="/prelaunch">
