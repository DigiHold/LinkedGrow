...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "free linkedin post creator ai",
    "generate linkedin posts free",
    "ai post writer linkedin free",
    "free ai writing tool linkedin",
    "linkedin post maker free ai",
  ],
  openGraph: {
    title: "AI LinkedIn Post Generator Free - Create Viral Posts in Seconds | LinkedGrow",
    description:
...
const postGenFreeFAQs = [
  ...
  },
  {
    ...
    answer:
      "The Starter plan is $19 per month with unlimited post generation, scheduling for up to 10 posts, and a content calendar. The Pro plan is $39 per month adding image generation, analytics, and engagement tools. With BYOK, most users spend $2 to $4 per month on AI API costs for regular posting.",
  },
  {
