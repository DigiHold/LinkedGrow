  ...
  return (
    <main className={V3_ROOT}>
      ...
      <LandingHero
        ...
        description="The 7-day Pro trial includes unlimited AI generation across 43 AI models (GPT, Claude, Gemini, Grok, Perplexity, Kimi) via BYOK, plus voice training, AI image generation, scheduling, and analytics. Test the full product before paying anything."
        valuePropBadges={[
      ...
      <LandingFeatures
        ...
        description="LinkedGrow's AI post generator is designed specifically for LinkedIn. Voice training, multiple post types, and 43 AI models - with a 7-day Pro trial to get you started."
        features={[
          {
            icon: Brain,
      ...
      <LandingFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "Yes. The Pro and Business plans both include unlimited scheduling. Publish directly to LinkedIn or schedule for optimal posting times.",
          },
          {
