...
const toolsFAQs = [
  ...
  },
  {
    ...
    answer:
      "Most LinkedIn content tools charge $49 to $199 per month and cap your generations. LinkedGrow Pro is $99 per month with unlimited post generation, image generation, analytics, network notifications and two agents that find your leads. The Business plan at $179 per month adds a third agent, carousel generator, A/B testing, team collaboration, advanced analytics, API access, and priority support. With the BYOK model, your posting AI costs $2 to $4 per month on average, billed by the provider with no markup.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. The 7-day Pro trial gives you full Pro access with unlimited AI generation, scheduling, image generation, and analytics - everything included. After the trial, paid plans start at $13/mo for Starter (unlimited generations, scheduling, content calendar). Pro at $27/mo adds image generation, analytics, and network notifications. Business at $55/mo adds carousel generator, A/B testing, team collaboration, advanced analytics, API access, and priority support.",
  },
  {
