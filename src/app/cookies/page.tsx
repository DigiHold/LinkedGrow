          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              {Object.entries(COOKIE_CATEGORIES).map(([key, category]) => (
                <div key={key} className="mb-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-xl font-medium">{category.name} Cookies</h3>
                    {category.required && (
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  <h4 className="font-medium mb-2">Google Analytics (GA4)</h4>
                ...
                <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  <h4 className="font-medium mb-2">Meta (Facebook/Instagram) Pixel</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  <h4 className="font-medium mb-2">TikTok Pixel</h4>
                  <p className="text-sm text-muted-foreground mb-2">
            ...
            <section className="mb-8">
              ...
              <div className="p-4 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800">
                <h4 className="font-medium mb-2">Reset Your Cookie Preferences</h4>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">6. EU/EEA Users</h2>
              <p className="text-muted-foreground">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">7. California Users (CCPA)</h2>
              <p className="text-muted-foreground">
