...
export const metadata: Metadata = {
  title: "Best LinkedIn Scheduling Tools in 2026: Ranked & Reviewed",
  description:
    "We tested the top LinkedIn scheduling tools for 2026. Ranked by use case, with pricing and pros/cons for each.",
  openGraph: {
    title: "Best LinkedIn Scheduling Tools in 2026: Ranked & Reviewed",
    description:
      "We tested the top LinkedIn scheduling tools for 2026. Ranked by use case, with pricing and pros/cons for each.",
