  ...
  return (
    <section className="relative z-10 pt-8 md:pt-16 pb-16 md:pb-24 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          <svg className="w-7 h-7 md:w-8 md:h-8" viewBox="0 0 1200 1200" fill="#1A1A1A">
        ...
        <motion.div
          ...
          className="absolute top-[55%] right-[3%] w-10 h-10 md:w-12 md:h-12 rounded-lg bg-black flex items-center justify-center shadow-lg opacity-40"
        >
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="flex flex-col items-center font-bold tracking-tight text-slate-900 dark:text-white mb-6"
        ...
        >
          ...
          >
            ...
            <motion.span
              className="absolute -bottom-1 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 rounded-full"
