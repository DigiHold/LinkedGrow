    ...
    <section className="relative z-10 pt-8 md:pt-16 pb-16 md:pb-24 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-20 left-[8%] w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-[#0A66C2] to-[#004182] flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute top-28 right-[10%] w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#10A37F] flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute top-[40%] left-[5%] w-12 h-12 md:w-14 md:h-14 rounded-xl bg-[#e96f4c] flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-36 left-[12%] w-11 h-11 md:w-13 md:h-13 rounded-full bg-gradient-to-br from-[#4285F4] via-[#9B72CB] to-[#D96570] flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-28 right-[15%] w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#20808D] flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute top-[55%] right-[3%] w-10 h-10 md:w-12 md:h-12 rounded-lg bg-black flex items-center justify-center shadow-lg opacity-10"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-[45%] left-[3%] w-9 h-9 md:w-11 md:h-11 rounded-full bg-[#0668E1] flex items-center justify-center shadow-lg opacity-10"
        >
