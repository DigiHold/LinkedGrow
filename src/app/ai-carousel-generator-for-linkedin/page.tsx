...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Carousel Generator for LinkedIn - Create Carousels That Convert | LinkedGrow",
    description:
      "AI-powered LinkedIn carousel generator. Multi-slide builder, AI content, brand customization. 2x more clicks.",
  ...
  twitter: {
    ...
    title: "AI Carousel Generator for LinkedIn | LinkedGrow",
    description:
      "Create LinkedIn carousels with AI. Multi-slide builder, brand customization, 2x more clicks.",
...
const carouselFAQs = [
  ...
  },
  {
    ...
    answer:
      "The carousel generator is available on the Business plan at $79 per month. This plan also includes A/B testing, team collaboration, advanced analytics, API access, and priority support. The Pro plan at $39 per month includes post generation and image generation but not carousel creation.",
  },
  {
