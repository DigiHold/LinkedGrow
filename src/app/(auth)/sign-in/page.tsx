...
function LinkedInIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#0A66C2" className={className}>
      <path d="M17.04 17.043h-2.962v-4.64c0-1.107-.023-2.531-1.544-2.531-1.544 0-1.78 1.204-1.78 2.449v4.722H7.792V7.5h2.845v1.3h.039c.397-.75 1.364-1.54 2.808-1.54 3.001 0 3.556 1.974 3.556 4.545v5.238zM4.447 6.194a1.72 1.72 0 11-.001-3.44 1.72 1.72 0 01.001 3.44zM5.93 17.043H2.963V7.5H5.93v9.543z"/>
    </svg>
  );
}
    ...
    <div className="relative w-full max-w-md">
      ...
      <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden">
        ...
        <div className="p-8 pb-6 text-center">
          ...
          <h1 className="text-[2rem] font-bold leading-[1.2] text-slate-900 dark:text-white mb-2">Welcome back</h1>
        ...
        <div className="px-8 pb-8">
          {registered && (
            <div className="mb-4 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 text-sm text-emerald-700 dark:text-emerald-400">
            ...
            {!requires2FA ? (
              ...
              <div className="space-y-4">
                <div className="text-center mb-4">
                  <div className="w-16 h-16 mx-auto rounded-full bg-linear-to-r from-cyan-500/20 to-blue-600/20 flex items-center justify-center mb-3">
                ...
                <input
                  ...
                  className="w-full h-16 text-center text-2xl tracking-widest font-mono rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                  autoFocus
                  required
                />
