        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-[15px] text-slate-500 dark:text-slate-400">
              Describe what you want to say and get a first draft in your voice.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <VideoModal videoId="LaFbdueDLBg" />
            <Link href="/docs/content-creation/post-generator" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg border border-border px-2.5 py-1.5 text-[13px] font-medium text-slate-500 transition-colors hover:border-slate-300 hover:text-slate-900 dark:text-slate-400 dark:hover:border-white/20 dark:hover:text-white">
