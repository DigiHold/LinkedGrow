          ...
          <CardContent className="py-12 px-8">
            <div className="text-center max-w-lg mx-auto">
              ...
              <p className="text-muted-foreground mb-4">
                We&apos;re working hard to bring you advanced LinkedIn analytics. This feature will provide deep insights including content performance by type, follower demographics, and exportable reports.
              </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">See which content types perform best</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">Follower Demographics</p>
                  <p className="text-xs text-muted-foreground">Understand who follows you</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Geographic and industry breakdown</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Download CSV and PDF reports</p>
                </div>
              </div>
            </div>
          </CardContent>
