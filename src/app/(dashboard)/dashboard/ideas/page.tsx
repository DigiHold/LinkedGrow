...
export default function IdeasPage() {
  ...
  const hasIdeasAccess = canAccessFeature(userPlan, "ideas");
  ...
  // Free plan - Ideas generator is Starter+ only
  if (!hasIdeasAccess) {
    return (
        ...
        <Card className="border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-900/10">
          <CardContent className="py-12 px-8">
            <div className="text-center max-w-md mx-auto">
              ...
              <h3 className="text-xl font-semibold mb-2">Available on Starter and above</h3>
              <p className="text-muted-foreground mb-6">
                The standalone Ideas generator is part of the Starter plan. Free users can still generate ideas inside the Post Generator (counts toward your 3 free posts per month).
              </p>
