...
const aiProviders = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: "gemini-2.5-pro-preview-05-06", name: "Gemini 2.5 Pro", tag: "Balanced", price: "$0.02/post", monthly: "~$0.60/mo" },
      { id: "gemini-2.5-flash-preview-05-20", name: "Gemini 2.5 Flash", tag: "Faster", price: "$0.0005/post", monthly: "~$0.02/mo" },
      { id: "gemini-2.0-flash", name: "Gemini 2.0 Flash", tag: "Stable", price: "$0.001/post", monthly: "~$0.03/mo" },
    ],
  },
  {
    id: "grok",
    ...
    models: [
      ...
      { id: "grok-3-mini-beta", name: "Grok 3 Mini", tag: "Faster", price: "$0.02/post", monthly: "~$0.60/mo" },
    ],
  },
  {
    id: "perplexity",
