...
const aiProviders = [
  {
    ...
    models: [
      { id: "gpt-5.2-pro", name: "GPT-5.2 Pro", tag: "Best Quality", price: "$0.35/post", monthly: "~$10.50/mo" },
  ...
  },
  {
    ...
    models: [
      { id: "claude-opus-4-5-20250514", name: "Claude Opus 4.5", tag: "Most Capable", price: "$0.05/post", monthly: "~$1.50/mo" },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "gemini-2.5-flash-preview-05-20", name: "Gemini 2.5 Flash", tag: "Faster", price: "$0.003/post", monthly: "~$0.09/mo" },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "grok-4-1-fast-reasoning", name: "Grok 4.1 Fast", tag: "Reasoning", price: "$0.03/post", monthly: "~$0.90/mo" },
      { id: "grok-3-beta", name: "Grok 3", tag: "Recommended", price: "$0.03/post", monthly: "~$0.90/mo" },
      { id: "grok-3-mini-beta", name: "Grok 3 Mini", tag: "Fastest (90% cheaper)", price: "$0.002/post", monthly: "~$0.06/mo" },
    ],
  },
  {
    id: "perplexity",
    name: "Perplexity",
    description: "Sonar Pro, Sonar Reasoning, Sonar Deep Research",
    placeholder: "pplx-...",
    icon: PerplexityIcon,
    apiKeyUrl: "https://www.perplexity.ai/settings/api",
    models: [
      { id: "sonar-deep-research", name: "Sonar Deep Research", tag: "Best Research", price: "$0.10/post", monthly: "~$3.00/mo" },
      { id: "sonar-reasoning-pro", name: "Sonar Reasoning Pro", tag: "Deep Reasoning", price: "$0.05/post", monthly: "~$1.50/mo" },
      { id: "sonar-pro", name: "Sonar Pro", tag: "Recommended", price: "$0.04/post", monthly: "~$1.20/mo" },
      { id: "sonar", name: "Sonar", tag: "Faster", price: "$0.02/post", monthly: "~$0.60/mo" },
    ],
  },
];
...
const imageProviders = [
  ...
  },
  {
    id: "replicate",
    name: "Replicate",
    description: "FLUX 1.1 Pro, FLUX Schnell",
    placeholder: "r8_...",
    icon: ReplicateIcon,
    apiKeyUrl: "https://replicate.com/account/api-tokens",
    note: "FLUX - best open-source image generation with fine-tuning support",
    price: "$0.003-0.055/image",
    monthly: "~$0.09-1.65/mo (30 images)",
    hasResolution: true,
    hasAspectRatio: true,
    hasGuidanceScale: true,
    models: [
      { id: "flux-1.1-pro-ultra", name: "FLUX 1.1 Pro Ultra", tag: "4MP + Realism ($0.06)" },
      { id: "flux-1.1-pro", name: "FLUX 1.1 Pro", tag: "Best Quality ($0.055)" },
      { id: "flux-1-dev", name: "FLUX.1 Dev", tag: "Standard ($0.03)" },
