...
interface PrelaunchHeaderProps {
  ...
  /** Override the auto-detected slug for the edit link */
  editSlug?: string;
  /** Page status badge */
...
export function PrelaunchHeader({ showCountdown = false, timeLeft, editSlug, pageStatus }: PrelaunchHeaderProps) {
  ...
  // Auto-detect CMS slug from URL pathname (strip leading slash)
  const slug = editSlug || (pathname ? pathname.replace(/^\//, "") || "prelaunch" : "prelaunch");
