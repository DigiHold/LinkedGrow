...
const aiProviders = [
  {
    ...
    models: [
      { id: "o4-mini", name: "o4-mini", recommended: true, price: "~$0.01/post" },
      { id: "gpt-5", name: "GPT-5", price: "~$0.02/post" },
      { id: "gpt-5-nano", name: "GPT-5 Nano", price: "~$0.002/post" },
    ],
  },
  {
    id: "anthropic",
    ...
    models: [
      { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", recommended: true, price: "~$0.03/post" },
      { id: "claude-opus-4-6", name: "Claude Opus 4.6", price: "~$0.05/post" },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "gemini-3-pro-preview", name: "Gemini 3 Pro", price: "~$0.03/post" },
  ...
  },
  {
    ...
    models: [
      { id: "grok-4-1-fast-reasoning", name: "Grok 4.1 Fast", recommended: true, price: "~$0.01/post" },
      { id: "grok-4", name: "Grok 4", price: "~$0.03/post" },
      { id: "grok-3", name: "Grok 3", price: "~$0.03/post" },
    ],
  },
  {
    id: "perplexity",
    ...
    models: [
      ...
      { id: "sonar", name: "Sonar", price: "~$0.002/post" },
    ],
  },
  {
    id: "kimi",
    name: "Kimi",
    description: "K2.5, K2 by Moonshot",
    icon: KimiIcon,
    placeholder: "sk-...",
    ...
    models: [
      { id: "kimi-k2", name: "Kimi K2", recommended: true, price: "~$0.015/post" },
      { id: "kimi-k2.5", name: "Kimi K2.5", price: "~$0.02/post" },
    ],
  },
];
