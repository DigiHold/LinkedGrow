        ...
        <div className={PLANS}>
          ...
          <div className={`${PLAN} ${PLAN_PLAIN} ${RV_STATE}`}>
            ...
            <ul className={PLAN_UL}>
              ...
              <li className={PLAN_LI}><i className={PLAN_LI_I}><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.6"><path d="M20 6L9 17l-5-5" /></svg></i><span>Every reply has an owner, so nobody answers twice</span></li>
