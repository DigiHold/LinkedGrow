        ...
        <div className={PLANS}>
          <div className={`${PLAN} ${PLAN_BEST} ${RV_STATE}`}><span className={PLAN_TAG}>Where most founders start</span>
            ...
            <ul className={PLAN_UL}>
              <li className={PLAN_LI}><i className={PLAN_LI_I}><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.6"><path d="M20 6L9 17l-5-5" /></svg></i><span><b>2 AI agents</b>, 2 LinkedIn accounts, 2 audiences, 2 dedicated IPs</span></li>
              ...
              <li className={PLAN_LI}><i className={PLAN_LI_I}><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.6"><path d="M20 6L9 17l-5-5" /></svg></i><span>One shared pool and one do-not-contact list, so nobody is contacted twice</span></li>
