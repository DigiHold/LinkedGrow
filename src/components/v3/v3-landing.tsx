    ...
    <div className={V3_ROOT}>
      ...
      <section className={HERO_FIELD}>
        ...
        <div className={`${WRAP} relative z-[3] text-center`}>
          ...
          <p className={`${RV} mt-[13px] font-v3-mono text-[12.5px] text-[rgba(255,255,255,.48)]`} style={{ "--d0": ".31s" } as React.CSSProperties}>Use any agent: OpenClaw / Hermes / Claude / ChatGPT / Codex / Cursor</p>
