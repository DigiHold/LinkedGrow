    ...
    <main className={V3_ROOT}>
      ...
      <section className={`${SEC} ${MCP}`} id="mcp">
        <div className={WRAP}>
          ...
          <div className={MCPGRID}>
            <div className={`${MCARD} ${MCARD_A} ${RV_STATE}`}>
              ...
              <div className={CHAT}>
                <div className={MCLIP}><V3Clip name="chatgpt" label="ChatGPT calling find_leads, then reading back the three warmest people it found" /></div>
                <div className={MRUN}><i className={MRUN_DOT}></i>queues the search · nothing is sent without you</div>
              </div>
            </div>
        ...
        <circle cx="76" cy="34" r="2.5" fill="#00e5cc" /></svg></span>
              ...
              <div className={CHAT}>
                <div className={MCLIP}><V3Clip name="openclaw" label="OpenClaw checking for new leads every morning and preparing the replies" /></div>
                <div className={MRUN}><i className={MRUN_DOT}></i>runs on a schedule · you approve before anything sends</div>
              </div>
            </div>
            ...
            <div className={`${MCARD} ${MCARD_FLIP} ${MCARD_C} ${RV_STATE}`}>
              ...
              <p className={MCARD_P}>Write next week from the terminal you already live in, then have it scheduled without opening a tab.</p>
              <div className={CHAT}>
                <div className={MCLIP}><V3Clip name="claude" label="Claude Code drafting next week's posts and scheduling them Monday to Friday" /></div>
            ...
            <div className={`${MCARD} ${MCARD_D} ${RV_STATE}`}>
              ...
              <div className={CHAT}>
                <div className={MCLIP}><V3Clip name="hermes" label="Hermes running the daily loop on its own and reporting what it did" /></div>
                <div className={MRUN}><i className={MRUN_DOT}></i>one endpoint · every write is reversible from the dashboard</div>
              </div>
            </div>

            <div className={`${MCARD} ${MCARD_E} ${MCARD_WIDE} ${RV_STATE}`}>
              <div>
                <div>
                  <span className={MTILE}><svg viewBox="0 0 1024 1024"><path d="M395.479 633.828L735.91 381.105C752.599 368.715 776.454 373.548 784.406 392.792C826.26 494.285 807.561 616.253 724.288 699.996C641.016 783.739 525.151 802.104 419.247 760.277L303.556 814.143C469.49 928.202 670.987 899.995 796.901 773.282C896.776 672.843 927.708 535.937 898.785 412.476L899.047 412.739C857.105 231.37 909.358 158.874 1016.4 10.6326C1018.93 7.11771 1021.47 3.60279 1024 0L883.144 141.651V141.212L395.392 633.916" /><path d="M325.226 695.251C206.128 580.84 226.662 403.776 328.285 301.668C403.431 226.097 526.549 195.254 634.026 240.596L749.454 186.994C728.657 171.88 702.007 155.623 671.424 144.2C533.19 86.9942 367.693 115.465 255.323 228.382C147.234 337.081 113.244 504.215 171.613 646.833C215.216 753.423 143.739 828.818 71.7385 904.916C46.2237 931.893 20.6216 958.87 0 987.429L325.139 695.339" /></svg></span>
                  <h3 className={MCARD_H3}>Via Grok Bot</h3>
                  <p className={MCARD_P}>Message it the way you would a teammate. It reads who answered overnight, drafts what to say back, and leaves the sending to you.</p>
                </div>
                <div className={CHAT}>
                  <div className={MCLIP}><V3Clip name="grok" label="Grok Bot reading the overnight replies and drafting the answers" /></div>
                  <div className={MRUN}><i className={MRUN_DOT}></i>a custom connector · one URL and your key</div>
                </div>
              </div>
            </div>
          </div>
