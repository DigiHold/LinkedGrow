    ...
    <div className="v3">
      ...
      <footer>
        <div className="wrap">
          <div className="fg">
            <div>
              <a className="brand" href="#" style={{ marginBottom: "16px" }}><span className="tile s"><svg><use href="#mark" /></svg></span>
                <span className="wm" style={{ fontSize: "20px" }}>Linked<i>Grow</i></span></a>
              <p style={{ fontSize: "14.5px", color: "var(--mut)", maxWidth: "35ch" }}>The LinkedIn agent that finds your buyers, warms them up and opens the conversation, every working day, at human pace, from an address of its own.</p>
              <div className="soc" style={{ marginTop: "24px" }}>
                <a href="#" aria-label="LinkedIn" style={{ "--sc": "#0A66C2" } as React.CSSProperties}><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.45 20.45h-3.56v-5.57c0-1.33-.03-3.04-1.85-3.04-1.86 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05a3.74 3.74 0 013.37-1.85c3.6 0 4.27 2.37 4.27 5.46zM5.34 7.43a2.06 2.06 0 112.06-2.06 2.06 2.06 0 01-2.06 2.06zM7.12 20.45H3.55V9h3.57zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.72V1.72C24 .77 23.2 0 22.22 0z" /></svg></a>
                <a href="#" aria-label="X" style={{ "--sc": "#0f1419" } as React.CSSProperties}><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.41l-5.8-7.58-6.64 7.58H.46l8.6-9.83L0 1.15h7.59l5.24 6.93zm-1.29 19.5h2.04L6.49 3.24H4.3z" /></svg></a>
                <a href="#" aria-label="Facebook" style={{ "--sc": "#1877F2" } as React.CSSProperties}><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z" /></svg></a>
                <a href="#" aria-label="YouTube" style={{ "--sc": "#FF0000" } as React.CSSProperties}><svg width="19" height="19" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.19a3.02 3.02 0 00-2.12-2.14C19.5 3.55 12 3.55 12 3.55s-7.5 0-9.38.5A3.02 3.02 0 00.5 6.19C0 8.08 0 12 0 12s0 3.92.5 5.81a3.02 3.02 0 002.12 2.14c1.88.5 9.38.5 9.38.5s7.5 0 9.38-.5a3.02 3.02 0 002.12-2.14C24 15.92 24 12 24 12s0-3.92-.5-5.81zM9.55 15.57V8.43L15.82 12z" /></svg></a>
              </div>
            </div>
            <div><h4>Quick links</h4>
              <div className="twocol">
                <ul>
                  <li><a href="#">Features</a></li><li><a href="#">Pricing</a></li><li><a href="#">Blog</a></li>
                  <li><a href="#">Industries</a></li><li><a href="#">Who it's for</a></li><li><a href="#">Use cases</a></li></ul>
                <ul>
                  <li><a href="#">About us</a></li><li><a href="#">Help center</a></li><li><a href="#">Documentation</a></li>
                  <li><a href="#">Privacy</a></li><li><a href="#">Terms</a></li><li><a href="#">Cookies</a></li></ul>
              </div></div>
            <div><h4>Compare</h4><ul>
              <li><a href="#">vs Expandi</a></li><li><a href="#">vs HeyReach</a></li><li><a href="#">vs Dripify</a></li>
              <li><a href="#">vs Waalaxy</a></li><li><a href="#">vs Gojiberry</a></li><li><a href="#">vs Taplio</a></li></ul></div>
            <div><h4>Leave us a review</h4>
              <div style={{ display: "grid", gap: "11px" }}>
                <a className="rvb" href="#" style={{ "--rc": "#4285F4" } as React.CSSProperties}>
                  <svg className="lg" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" /><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.65l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0012 23z" /><path fill="#FBBC05" d="M5.84 14.09a6.6 6.6 0 010-4.18V7.07H2.18a11 11 0 000 9.86l3.66-2.84z" /><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1a11 11 0 00-9.82 6.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" /></svg>
                  <span><span className="strs">★★★★★</span><small>Review us on Google</small></span></a>
                <a className="rvb" href="#" style={{ "--rc": "#00B67A", "--sc": "#00B67A" } as React.CSSProperties}>
