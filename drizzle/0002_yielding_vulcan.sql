...
CREATE TABLE `__new_ideas` (
	...
	`source` text,
	`source_url` text,
	`created_at` integer DEFAULT '"2026-01-15T09:53:05.728Z"',
...
CREATE TABLE `__new_posts` (
	...
	`error_message` text,
	`created_at` integer DEFAULT '"2026-01-15T09:53:05.728Z"',
	`updated_at` integer DEFAULT '"2026-01-15T09:53:05.728Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`image_provider` text,
	`image_api_key` text,
	`created_at` integer DEFAULT '"2026-01-15T09:53:05.727Z"',
	`updated_at` integer DEFAULT '"2026-01-15T09:53:05.727Z"'
);
--> statement-breakpoint
INSERT INTO `__new_users`("id", "name", "email", "email_verified", "image", "password", "two_factor_enabled", "two_factor_secret", "is_admin", "plan", "stripe_customer_id", "stripe_subscription_id", "linkedin_access_token", "linkedin_refresh_token", "linkedin_token_expiry", "linkedin_profile_id", "linkedin_profile_name", "ai_provider", "ai_api_key", "ai_model", "sample_posts", "never_mention", "business_description", "target_audience", "writing_tone", "image_provider", "image_api_key", "created_at", "updated_at") SELECT "id", "name", "email", "email_verified", "image", "password", "two_factor_enabled", "two_factor_secret", "is_admin", "plan", "stripe_customer_id", "stripe_subscription_id", "linkedin_access_token", "linkedin_refresh_token", "linkedin_token_expiry", "linkedin_profile_id", "linkedin_profile_name", "ai_provider", "ai_api_key", "ai_model", "sample_posts", "never_mention", "business_description", "target_audience", "writing_tone", "image_provider", "image_api_key", "created_at", "updated_at" FROM `users`;--> statement-breakpoint
