  ...
  async headers() {
    ...
    return [
      ...
      },
      {
        ...
        source: "/:path(prelaunch|about|privacy|terms|cookies|beta|sign-in|sign-up|pricing|blog|blog/.*|docs|docs/.*|help|for/.*|features/.*|free-tools/.*|use-cases/.*|industries/.*|compare/.*|affiliate|affiliate/.*|free-linkedin-course|switch-to-claude|linkedin-profile-views-guide)",
        headers: [
          {
            key: "Cache-Control",
