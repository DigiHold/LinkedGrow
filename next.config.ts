  ...
  async headers() {
    ...
    return [
      ...
      },
      {
        ...
        source: "/:path(prelaunch|about|privacy|terms|cookies|beta|sign-in|sign-up|pricing|blog|blog/.*|for/.*|features/.*|free-tools/.*|use-cases/.*|industries/.*|compare/.*|affiliate|affiliate/.*)",
        headers: [
          {
            key: "Cache-Control",
