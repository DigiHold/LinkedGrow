  ...
  async headers() {
    ...
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://www.googletagmanager.com https://connect.facebook.net https://t.contentsquare.net https://snap.licdn.com",
          "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
          "img-src 'self' data: blob: https://*.r2.dev https://*.r2.cloudflarestorage.com https://media.licdn.com https://www.googletagmanager.com https://www.facebook.com https://www.linkedin.com https://px.ads.linkedin.com",
          "font-src 'self' data: https://fonts.gstatic.com",
          "connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://connect.facebook.net https://t.contentsquare.net https://www.linkedin.com https://px.ads.linkedin.com https://www.googleapis.com https://fonts.googleapis.com",
