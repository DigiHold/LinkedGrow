...
export function buildVerifyPrompt(comment: string, facts: string): string {
  return [
    ...
    "",
    "Opinions, questions and general statements about the world are fine and are not claims about",
    "the person. Only what the person says they did, saw, built, measured or lived through has to",
    "appear in the list, and it has to appear the way the comment describes it.",
    "",
